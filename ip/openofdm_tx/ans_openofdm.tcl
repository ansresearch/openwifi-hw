...
#
# ans_openofdm.tcl: Tcl script for re-creating project 'openofdm_tx'
#
# Generated by Vivado on Tue Mar 22 10:43:41 CET 2022
...
set _xil_proj_name_ "ans_openofdm_tx"
...
set script_file "ans_openofdm.tcl"
...
# Create project
create_project ${_xil_proj_name_} "./openofdm_tx" -part xc7z045ffg900-2
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../ip_repo/common/openofdm_tx"]" $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../../ip_repo/common/openofdm_tx/component.xml"] \
]
...
set file "$origin_dir/src/custom_LTFphased_rom.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/ltf_generator.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../ip_repo/common/openofdm_tx/component.xml"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
